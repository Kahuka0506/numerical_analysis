...
void solve(){
    ...
    auto [lambda, x] = power_method(A);
    cout << lambda << endl;
    outve(x);
    cout << endl;
    
    
    cout << "power method shift" << endl;
    auto [lambda2, x2] = power_method_shift(A,0.04);
    cout << lambda2 << endl;
    outve(x2);
    cout << endl;
    
    cout << "inverse poer method" << endl;
    auto [lambda1, x1] =inv_power_method(A);
    cout << lambda1 << endl;
    outve(x1);
    cout << endl;
